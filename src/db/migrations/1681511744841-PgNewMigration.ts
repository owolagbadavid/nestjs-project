...
export class PgNewMigration1681511744841 implements MigrationInterface {
    name = 'PgNewMigration1681511744841'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "advance_forms" ("id" SERIAL NOT NULL, "userId" integer, "purpose" character varying NOT NULL, "depatureDate" TIMESTAMP NOT NULL, "returnDate" TIMESTAMP NOT NULL, "origination" character varying NOT NULL, "destination" character varying NOT NULL, "preApprovalRemarkByFinance" character varying, "financeGoAhead" boolean, "approvalLevel" "public"."advance_forms_approvallevel_enum" NOT NULL, "nextApprovalLevel" "public"."advance_forms_nextapprovallevel_enum", "delegatedByPD" boolean NOT NULL DEFAULT false, "pushedToFinance" boolean NOT NULL DEFAULT false, "approvedByFin" boolean NOT NULL DEFAULT false, "rejected" boolean NOT NULL DEFAULT false, "rejectionReason" character varying, "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "remarkByFin" character varying, "retirementId" integer, "totalAmount" integer NOT NULL, "supervisorToken" character varying, CONSTRAINT "REL_a50172b67328804b2af46bea8e" UNIQUE ("retirementId"), CONSTRAINT "PK_86d8c596266c93e0312628098af" PRIMARY KEY ("id"))`);
