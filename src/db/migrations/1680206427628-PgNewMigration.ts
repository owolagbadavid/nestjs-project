...
export class PgNewMigration1680206427628 implements MigrationInterface {
    name = 'PgNewMigration1680206427628'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "retirement_form" ("id" SERIAL NOT NULL, "userId" integer, "purpose" character varying NOT NULL, "depatureDate" TIMESTAMP NOT NULL, "returnDate" TIMESTAMP NOT NULL, "type" "public"."retirement_form_type_enum" NOT NULL, "preApprovalRemarkByFinance" character varying, "financeGoAhead" boolean, "approvalLevel" integer NOT NULL, "nextApprovalLevel" integer, "delegatedByPD" boolean NOT NULL DEFAULT false, "pushedToFinance" boolean NOT NULL DEFAULT false, "approvedByFin" boolean NOT NULL DEFAULT false, "rejected" boolean NOT NULL DEFAULT false, "rejectionReason" character varying, "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "remarkByFin" character varying, "totalAmount" integer NOT NULL, "balanceToStaff" integer NOT NULL, "balanceToOrganization" integer NOT NULL, "supervisorToken" character varying, CONSTRAINT "PK_2790fa54ad959e79fef183ac638" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "advance_form" ("id" SERIAL NOT NULL, "userId" integer, "purpose" character varying NOT NULL, "depatureDate" TIMESTAMP NOT NULL, "returnDate" TIMESTAMP NOT NULL, "origination" character varying NOT NULL, "destination" character varying NOT NULL, "preApprovalRemarkByFinance" character varying, "financeGoAhead" boolean, "approvalLevel" integer NOT NULL, "nextApprovalLevel" integer, "delegatedByPD" boolean NOT NULL DEFAULT false, "pushedToFinance" boolean NOT NULL DEFAULT false, "approvedByFin" boolean NOT NULL DEFAULT false, "rejected" boolean NOT NULL DEFAULT false, "rejectionReason" character varying, "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "remarkByFin" character varying, "retirementId" integer, "totalAmount" integer NOT NULL, "supervisorToken" character varying, CONSTRAINT "REL_560a468e3547dd7b4e56681676" UNIQUE ("retirementId"), CONSTRAINT "PK_97adc511b6b672cf19a63009344" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "advance_details" ADD CONSTRAINT "FK_c00ad2bc4eec151cc233919cac0" FOREIGN KEY ("advanceFormId") REFERENCES "advance_form"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        ...
        await queryRunner.query(`ALTER TABLE "advance_form" ADD CONSTRAINT "FK_560a468e3547dd7b4e566816764" FOREIGN KEY ("retirementId") REFERENCES "retirement_form"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
