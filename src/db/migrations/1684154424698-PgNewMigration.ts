...
export class PgNewMigration1684154424698 implements MigrationInterface {
    name = 'PgNewMigration1684154424698'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "advance_details" ("id" SERIAL NOT NULL, "advanceFormId" integer, "product" character varying NOT NULL, "rate" integer NOT NULL, "amount" integer NOT NULL, "number" integer NOT NULL, "remark" character varying NOT NULL, CONSTRAINT "PK_b6f7fbfaff1472afed14035e5a7" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "expense_details" ("id" SERIAL NOT NULL, "retirementFormId" integer, "product" character varying NOT NULL, "rate" integer NOT NULL, "amount" integer NOT NULL, "number" integer NOT NULL, "remark" character varying NOT NULL, CONSTRAINT "PK_8012987d153b25cc960f171b920" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "users" ADD CONSTRAINT "FK_f4a582b56f240c4c974fabc6dd1" FOREIGN KEY ("delegateId") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "departments" ADD CONSTRAINT "FK_7dfc8e5b4441db5ca69bb532a13" FOREIGN KEY ("headId") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "units" ADD CONSTRAINT "FK_9a238cbdc411387b8a96cfa6a9a" FOREIGN KEY ("departmentId") REFERENCES "departments"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "units" ADD CONSTRAINT "FK_67d7ca900aeb1736eea1322637f" FOREIGN KEY ("headId") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "supporting_docs" ADD CONSTRAINT "FK_5a2041011809703cd616f7b6006" FOREIGN KEY ("advanceFormId") REFERENCES "advance_forms"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "supporting_docs" DROP CONSTRAINT "FK_5a2041011809703cd616f7b6006"`);
